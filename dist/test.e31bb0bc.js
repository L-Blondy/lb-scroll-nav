...
function setScrollNav(sections, sectionContainer) {
  var refs = {};
  var maxElemRef;
  ...
  function callback(entries) {
    entries.forEach(function (entry) {
      ...
      [].forEach.call(activeLinks, function (link) {
      ...
      for (var ref in refs) {
        ...
        if (refs[ref] > 0.5) {
          var link = document.querySelector("[href=\"#".concat(ref, "\"]"));
      ...
      if (maxRatio <= 0.5) {
        var _link = document.querySelector("[href=\"#".concat(maxElemRef, "\"]"));
...
},{"./index.css":"../index.css"}],"index.js":[function(require,module,exports) {
"use strict";
...
(0, _index2.default)(sections, sectionContainer);
},{"./index.css":"index.css","../index.js":"../index.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
